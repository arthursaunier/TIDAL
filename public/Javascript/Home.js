...
var partie3 = "<br><br><input  type='submit' name='con' class='btn btn-secondary btn-sm border-white bg-white text-black' value='connexion'> <input  type='submit' name='inscrip' class='btn btn-secondary btn-sm border-white bg-white text-black' value='inscription'></div></div></form>";
